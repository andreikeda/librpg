...
/**
 * Interface that implements common methods by {@link Helm} instance.
 * 
 ...
 * @see Helm.Type
 */
public interface HelmListener {
	
	/**
	 * Creates instance of {@link Helm}.
	 * 
	 ...
	 * @param type - {@link Helm.Type}
	 */
	public void create(long id, String name, String description, int[] attRequirements, double cost, int quantity, Damage redutor, int durability, Helm.Type type);
